                ...
                <div className="d-flex flex-column" style={{ width: "100%", alignItems: "center" }}>
                    ...
                    <div className="m-5 ">
                        <Link className="btn btn-secondary  rowBT"
                            type="button" to="/eyebased/postcd2">
                            조건 후 설문
                        </Link>
                    </div>
                    ...
                    <div className="m-5 ">
                        ...
                        <a className="btn btn-black rowBT" href="https://forms.gle/Jn8PZEh6gm53EoEr5" 
                    ...
                    <div className="m-5 ">
                        ...
                        <a className="btn btn-red rowBT" href="https://forms.gle/81v1BQB39A36rwhb9" 
                            target="_blank" rel="noopener noreferrer">
                            사후 설문 (우주 Task)
                        </a>
