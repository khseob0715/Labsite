...
function PostCD() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycby9ktvPk-VkstfPBd9SbaCtj8GppWGhIykSsDuoL-_eM34asf8lA8zfDwMWWXjA-XT6/exec";
    ...
    function calculateENJ() {
        handleQuestionChange("ENJ_Average",
            (

                (parseInt(formData['ENJ_1']) +
                    parseInt(formData['ENJ_2']) +
                    parseInt(formData['ENJ_3'])) / 3
            )
        );
    }
    ...
    function calculateVF() {
        ...
        handleQuestionChange("VF_Average",
            (
                (
                    parseInt(formData['VF_1'])
                    + parseInt(formData['VF_2'])
    ...
    const ENJShortForm = [
        {
            "key": 1,
            "query": "나는 이 시스템을 사용하는 것이 즐거운 것 같다 (Enjoyable)",
            "saveId": "ENJ_1",
        },
        {
            "key": 2,
            "query": "나는 이 시스템을 사용하는 과정 자체가 즐겁다 (Pleasant)",
            "saveId": "ENJ_2",
        },
        {
            "key": 3,
            "query": "나는 이 시스템을 재미있게 사용했다. (Fun)",
            "saveId": "ENJ_3",
        },
    ]
    ...
    const VisualFatigueForm = [
        {
            "key": 1,
            "query": "눈 주위의 압박에 의한 불편함",
            "saveId": "VF_1",
        },
        {
            "key": 2,
            "query": "눈의 건조함에 의한 불편함",
            "saveId": "VF_2",
        },
        {
            "key": 3,
        ...
        {
            "key": 4,
            "query": "눈꺼풀이 무거워진 듯한 느낌에 의한 불편함",
            "saveId": "VF_4",
        },
        {
            "key": 5,
            "query": "눈물이 나는 듯한 느낌에 의한 불편함",
            "saveId": "VF_5",
        },
        {
            "key": 6,
            "query": "VR 화면을 보고 있을 때, 어지러움을 느낀 것에 대한 불편함",
            "saveId": "VF_6",
        },
        {
            "key": 7,
            "query": "VR 화면을 보고 있을 때, 화면이 흐려졌다고 느껴 생긴 불편함",
            "saveId": "VF_7",
        },
        {
            "key": 8,
            "query": "VR 화면을 보고 있을 때, 단어/모양이 중복되어 보임에 의한 불편함",
            "saveId": "VF_8",
        },
        {
            "key": 9,
            "query": "VR 화면을 보고 있을 때, 두통에 의한 불편함",
            "saveId": "VF_9",
        },
        {
            "key": 10,
            "query": "VR 화면을 보고 있을 때, 졸음이 오는 것에 의한 불편함",
            "saveId": "VF_10",
        },
        {
            "key": 11,
        ...
        {
            "key": 12,
            "query": "가까운 물체가 선명하게 보이지 않는 불편함",
            "saveId": "VF_12",
        },
        {
            "key": 13,
            "query": "멀리 있는 물체가 선명하게 보이지 않는 불편함",
            "saveId": "VF_13",
        },
        {
            "key": 14,
            "query": "눈을 문지르거나 마사지가 필요하다고 느끼는 불편함",
            "saveId": "VF_14",
        },
        {
            "key": 15,
            "query": "VR 화면을 보고 있을 때, 단어나 모양이 겹쳐 보이는 불편함",
            "saveId": "VF_15",
        },
    ]


    const [ENJContent, SetENJContents] = useState(ENJShortForm
        .map((q) => (
            <SliderQuestionMoreOptions
                key={q.key}
                question={q.query}
                ...
                step={1}
                marks={[
                    { value: 1, label: '전혀 동의 안함' },
                    { value: 2, label: '동의 안함' },
                    { value: 3, label: '약간 동의 안함' },
                    { value: 4, label: '중간' },
    ...
    const handleChange = (event, newValue) => {
        if (typeof newValue === 'number') {
            setValue(newValue);
            handleQuestionChange("perceivedTime", newValue)
        }
    };
                            ...
                            <div className="tab-content" id="cardTabContent">
                                <div className="tab-pane fade show active" id="SetupView" role="tabpanel" aria-labelledby="TabSetup">
                                    ...
                                    <RadioSelection
                                        ...
                                        optionNames={[
                                            "Earth_CC_all_Controller",
                                            "Earth_CG_Rotation_Gaze",
                                            "Earth_GC_Translation_Gaze",
                                            "Earth_GG_all_Gaze",
                                            "Space_CC_all_Controller",
                                            "Space_CG_Rotation_Gaze",
                                            "Space_GC_Translation_Gaze",
                                            "Space_GG_all_Gaze"
                                        ]}
                                    ...
                                    <ShortTextAnswer
                                        ...
                                        question={"실제시간"}
                                        hint={"초단위 작성"}
                                        onChange={(answer) => handleQuestionChange("realTime", answer)}
                                    />
                                ...
                                <div className="tab-pane fade show" id="TimeView" role="tabpanel" aria-labelledby="TabTime">
                                    {/* 설문 시작 시간 체크 validation */}
                                        ...
                                        <ShortTextAnswer
                                            SaveId={"perceivedTime"}
                                            question={"체감시간"}
                                            hint={"초단위 작성"}
                                            onChange={(answer) => handleQuestionChange("perceivedTime", answer)}
                                        />
