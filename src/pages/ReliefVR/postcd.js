...
function PostCD() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbyWrc7ciWaZc6ONmV4aXTrqlJ3p2KGw6zMJhTIe3RyDV2E7oVN0umeYy1vQGEoL85okAg/exec";
    ...
    return (
        <>
            ...
            <HEADER
                title={"Relief VR / Post Condition 설문"}
                        ...
                        <div className="card-body py-1 px-2" >
                            <div className="tab-content" id="cardTabContent">
                                ...
                                <div className="tab-pane face show" id="TLXView" role="tabpanel" aria-labelledby="TabTLX">
                                    ...
                                    <NASATLX
                                        question={"주어진 임무를 수행하는 데 필요한 신체적으로 얼마나 힘들었나요 (어느정도의 신체적 요구를 느꼈나요?)"}
                                        onChange={(answer) => handleQuestionChange("NASAPhysical", answer)}
                                    />

                                    <NASATLX
                                        question={"주어진 임무를 수행하는 데 필요한 정신적으로 얼마나 힘들었나요? (어느정도의 정신적 요구를 느꼈나요?) "}
                                        onChange={(answer) => handleQuestionChange("NASAMental", answer)}
                                    />

                                    <NASATLX
                                        question={"주어진 임무를 수행하는 데 필요한 시간적인 압박은 어느정도인가요? (어느정도의 시간적 요구를 느꼈나요?)"}
                                        onChange={(answer) => handleQuestionChange("NASATemporal", answer)}
                                    />

                                    <NASATLX
                                        question={"주어진 임무의 완료 수준을 평가한다면 어느정도인가요? (얼마나 잘 해냈다고 느꼈나요?)"}
                                        onChange={(answer) => handleQuestionChange("NASAPerformance", answer)}
                                    />

                                    <NASATLX
                                        question={"주어진 임무를 수행하는 데 필요한 집중과 신경써야 하는 수준은 어느정도인가요? (얼마나 많은 노력이 필요했나요?)"}
                                        onChange={(answer) => handleQuestionChange("NASAEffort", answer)}
                                    />

                                    <NASATLX
                                        question={"주어진 임무를 수행하는 데 얼마나 불안하고, 낙담하고, 짜증나고, 스트레스 받고, 짜증을 느꼈나요?"}
                                        onChange={(answer) => handleQuestionChange("NASAFrustration", answer)}
                                    />
