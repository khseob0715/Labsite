...
function Pre() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbxAs4IVHI4XijfEMq_-_piGEU0h9aLJL4Yxo5AO-MuUy8seF9RUojLm9-GTxf8f_3ft8g/exec"
                            ...
                            <ul className="nav nav-tabs card-header-tabs" id="cardTab" role="tablist">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link fw-900 text-lg"
                                        ...
                                        data-bs-toggle="tab" role="tab"
                                        aria-controls="PostView" aria-selected="false">PostView</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link fw-900 text-lg"
