...
function PostCD() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbwN97lGjEOSOaFyRE3ZAXRWu3J3qR7xkrv6moQONHU1-c8603IgJ-ALsYKJdJL_Eb5OPw/exec";
                        ...
                        <div className="card-body py-1 px-2" >
                            <div className="tab-content" id="cardTabContent">
                                <div className="tab-pane fade show active" id="SetupView" role="tabpanel" aria-labelledby="TabSetup">
                                    ...
                                    <RadioSelection
                                        SaveId={"RadioForPADays"}
                                        question={"해당 참가자가 방문한 횟수는?"}
                                        radioName={"RadioForPADays"}
                                        optionNames={[
                                            "1회차 방문",
                                            "2회차 방문"
                                        ]}
                                        onChange={(answer) => handleQuestionChange("RadioForPADays", answer)}
                                    />

                                    <RadioSelection
                                        SaveId={"RadioForPAEnv"}
                                        question={"해당 참가자가 체험하는 환경은"}
                                        radioName={"RadioForPAEnv"}
                                        optionNames={[
                                            "숲",
                                            "중세"
                                        ]}
                                        onChange={(answer) => handleQuestionChange("RadioForPAEnv", answer)}
                                    />
