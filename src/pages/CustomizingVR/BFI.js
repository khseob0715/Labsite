...
function BFI() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbw6g6kV0AVTr3dizx5nS34SSu0JagZzVVz_kSicmGM87O_QNLZLbbZkdDRHraEgSuLHXA/exec"
                            ...
                            <ul className="nav nav-tabs card-header-tabs" id="cardTab" role="tablist">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link fw-900 text-lg"
                                        ...
                                        data-bs-toggle="tab" role="tab"
                                        aria-controls="SSQView" aria-selected="false">BFI</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link fw-900 text-lg"
                                        id="TabPost" href="#PostView"
                                        data-bs-toggle="tab" role="tab"
                                        aria-controls="PostView" aria-selected="false">Post</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link fw-900 text-lg"
