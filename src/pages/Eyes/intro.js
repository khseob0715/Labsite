                ...
                <div className="d-flex flex-column" style={{ width: "100%", alignItems: "center" }}>
                    ...
                    <div className="m-5 ">
                        <Link className="btn btn-secondary  rowBT"
                            type="button" to="/eyebased/postcd">
                            조건 후 설문
                        </Link>
                    </div>
                    ...
                    <div className="m-5 ">
                        {/* <Link className="btn btn-red  rowBT"
                            type="button" to="https://forms.gle/KRkMqgk94hL68emH6">
                            사후 설문
                        </Link> */}
                        <a className="btn btn-red rowBT" href="https://forms.gle/SsLSjV2tgNadAXFZ7" 
