...
function PreQuesiton() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbzrSRqDQc5jeag_6nXQO5QQ-Vtfa-OOV5lnyGLt6Xq5OHwxyoQCk_cfKF-JPhByVPEQGg/exec"
                        ...
                        <div className="card-body py-1 px-2" >
                            <div className="tab-content" id="cardTabContent">
                                <div className="tab-pane fade show active" id="TabView_1" role="tabpanel" aria-labelledby="Tab_1">
                                    ...
                                    <ShortTextAnswer
                                        SaveId={"PALefteye"}
                                        question={"왼쪽 눈의 교정 시력"}
                                        hint={"대략적인 숫자를 입력해주세요"}
                                        onChange={(answer) => handleQuestionChange("PALefteye", answer)}
                                    />

                                    <ShortTextAnswer
                                        SaveId={"PARighteye"}
                                        question={"오른쪽 눈의 교정 시력"}
                                        hint={"대략적인 숫자를 입력해주세요"}
                                        onChange={(answer) => handleQuestionChange("PARighteye", answer)}
                                    />
