...
function PostCD() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbxAn8ZOaPbdud2RpCuTuTyjr_XdevOwtCIF0jD6ggaTURSTvmvBm83OjkW7b0K-fiLfgQ/exec";
    ...
    function calculateSART() {
        handleQuestionChange("SAR_U", (
            parseInt(formData['SAR_8']) + parseInt(formData['SAR_9']) + parseInt(formData['SAR_10'])
        ) / 3);

        handleQuestionChange("SAR_D", (
            parseInt(formData['SAR_1']) + parseInt(formData['SAR_2']) + parseInt(formData['SAR_3'])
        ) / 3);

        handleQuestionChange("SAR_S", (
            parseInt(formData['SAR_4']) + parseInt(formData['SAR_5']) + parseInt(formData['SAR_6']) + parseInt(formData['SAR_7'])
        ) / 4);

        handleQuestionChange("SAR_SA", ((
            parseInt(formData['SAR_8']) + parseInt(formData['SAR_9']) + parseInt(formData['SAR_10'])
        ) / 3) - (
                ((parseInt(formData['SAR_1']) + parseInt(formData['SAR_2']) + parseInt(formData['SAR_3'])) / 3 )
                - ((parseInt(formData['SAR_4']) + parseInt(formData['SAR_5']) + parseInt(formData['SAR_6']) + parseInt(formData['SAR_7'])) / 4)
        )
        );
    ...
    function calculateIPQ() {
        ...
        handleQuestionChange("IPQ_GENERAL", parseInt(formData['IPQ_1']));
    ...
    const SARTform = [
        {
            "key": 1,
            "query": "체험하는 가상 환경이나 체험 절차가 안정적이고 순조롭게 진행이 되었는가? 아니면 불안정하고 갑자기 변했는가? ",
            "saveId": "SAR_1",
            "leftLable": "매우 안정됨",
            "rightLable": "매우 불안정함"
        },
        {
            "key": 2,
            "query": "체험하는 가상 환경에서 얼마나 많은 요소들이 변화되고 있습니까? ",
            "saveId": "SAR_2",
            "leftLable": "매우 적음",
            "rightLable": "매우 많음"
        },
        {
            "key": 3,
            "query": "체험하는 가상 환경이나 체험 절차가 간단하였는가? 아니면 복잡하였는가? ",
            "saveId": "SAR_3",
            "leftLable": "매우 간단함",
            "rightLable": "매우 복잡함"
        }, {
            "key": 4,
            "query": "얼마나 경각심을 가지고 주변 상황을 관찰하였습니까?",
            "saveId": "SAR_4",
            "leftLable": "경계하지 않음",
            "rightLable": "매우 경계함"
        }, {
            "key": 5,
            "query": "체험하는 가상 환경을 위해서 얼마나 많은 정신적 능력을 사용했습니까? ",
            "saveId": "SAR_5",
            "leftLable": "전혀 없음",
            "rightLable": "매우 많음"
        }, {
            "key": 6,
            "query": "가상 환경을 체험하면서 당신은 하나 혹은 여러 요소에 집중하였습니까?",
            "saveId": "SAR_6",
            "leftLable": "오직 하나에 집중함",
            "rightLable": "여러 요소에 집중함"
        }, {
            "key": 7,
            "query": "가상 환경을 체험하면서 당신은 하나 혹은 여러 요소에 관심을 가졌습니까? ",
            "saveId": "SAR_7",
            "leftLable": "오직 하나에 관심을 가짐",
            "rightLable": "여러 요소에 관심을 가짐"
        }, {
            "key": 8,
            "query": "가상 환경을 체험하면서 얼마나 많은 정보를 획득하였나요? ",
            "saveId": "SAR_8",
            "leftLable": "전혀 없음",
            "rightLable": "매우 많음"
        }, {
            "key": 9,
            "query": "가상 환경을 체험하면서 획득한 정보가 얼마나 유용합니까?",
            "saveId": "SAR_9",
            "leftLable": "전혀 유용하지 않음",
            "rightLable": "매우 유용함"
        }, {
            "key": 10,
            "query": "작업을 수행하는 동안 주변 환경에 익숙해졌나요? ",
            "saveId": "SAR_10",
            "leftLable": "전혀 아님",
            "rightLable": "매우 그러함"
        },
    ...
    const IPQContnetForm = [
        {
            "key": 1,
            "query": "나는 가상 세계에 나의 몸과 마음이 `그곳에 있다`는 느낌을 받았다. (현장감) ",
            "saveId": "IPQ_1",
            "optionLabels": [
                { value: 0, label: '전혀 아님' },
                { value: 1, label: '' },
    ...
    const [SARTContents, SetSARTContents] = useState(SARTform
        .map((q) => (
            <SliderQuesiton
                key={q.key}
                question={q.query}
                    ...
                    <div className="col-xl-10">
                        <div className="card-header border-bottom invisible">
                            <ul className="nav nav-tabs card-header-tabs" id="cardTab" role="tablist">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link fw-900 text-lg"
                                        id="TabSART" href="#SARTView"
                                        data-bs-toggle="tab" role="tab"
                                        aria-controls="SARTView" aria-selected="false">SART</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link fw-900 text-lg"
                        ...
                        <div className="card-body py-1 px-2" >
                            <div className="tab-content" id="cardTabContent">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                if (CheckValidate([
                                                    ...
                                                    scrollToTop();
                                                    calculateIPQ();
                                                    document.getElementById("TabSART").click();
                                                } else {
                                                    alert.show('답변되지 않은 질문이 있습니다.', { type: types.ERROR }) //alert will be shown in bottom left
                                                    console.log("is not a validate. Check all quesitons");
                                                }
                                ...
                                <div className="tab-pane fade show" id="SARTView" role="tabpanel" aria-labelledby="TabSART">
