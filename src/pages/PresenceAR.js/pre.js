...
function PreQuesiton() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbz8kBsbVlf4ZaftPWVdbSkeqQfImyuD5Qo3Lw_ZkvHNe2_6z8NrpuBB6nCLmHn3UemP/exec"
                        ...
                        <div className="card-body py-1 px-2" >
                            <div className="tab-content" id="cardTabContent">
                                <div className="tab-pane fade show active" id="TabView_1" role="tabpanel" aria-labelledby="Tab_1">
                                    ...
                                    <ShortTextAnswer
                                        SaveId={"PAHeight"}
                                        question={"신장을 입력해주세요. (ex. 키가 180cm면 180)"}
                                        hint={"숫자를 입력해주세요"}
                                    ...
                                    <ShortTextAnswer
                                        SaveId={"PAWeight"}
                                        question={"몸무게를 입력해주세요. (ex. 몸무게가 80kg 이면 80)"}
                                        hint={"숫자를 입력해주세요"}
                                ...
                                <div className="tab-pane fade" id="TabView_PANAS" role="tabpanel" aria-labelledby="Tab_PANAS">
                                    ...
                                    <RadioSelection
                                        SaveId={"RadioForArmy"}
                                        question={"어느 군에 소속되셨나요?(예비군 포함)"}
                                        radioName={"RadioForArmy"}
                                        optionNames={[
                                            "육군",
                                            "해군/해병대",
                                            "공군"
                                        ]}
                                        onChange={(answer) => handleQuestionChange("RadioForArmy", answer)}
                                    />

                                    <RadioSelection
                                        SaveId={"RadioForArmyLevel"}
                                        question={"군 신분이 어떻게 되셨나요? "}
                                        radioName={"RadioForArmyLevel"}
                                        optionNames={[
                                            "장교",
                                            "부사관",
                                            "병"
                                        ]}
                                        onChange={(answer) => handleQuestionChange("RadioForArmyLevel", answer)}
                                    />



                                    <RadioSelection
                                        SaveId={"PA_Activities_1"}
                                        question={"군생활 중 동료, 교관 등과 함께 행동하는 근접전투 훈련을 경험해보셨나요? * ex) KCTC(과학화훈련), 유격 훈련, CTC 훈련 등"}
                                        radioName={"PA_Activities_1"}
                                        optionNames={[
                                            "아니오",
                                            "예"
                                        ]}
                                        onChange={(answer) => handleQuestionChange("PA_Activities_1", answer)}
                                    />


                                    <ShortTextAnswer
                                        SaveId={"PA_Activities_2"}
                                        question={"어떤 훈련이었나요? (간략하게 작성하셔도 됩니다.)"}
                                        hint={"텍스트 입력해주세요"}
                                        onChange={(answer) => handleQuestionChange("PA_Activities_2", answer)}
                                    />

                                    <ShortTextAnswer
                                        SaveId={"PA_Activities_3"}
                                        question={"상기 훈련을 포함한 훈련, 교육을 받을 때 교관(또는 조교)에게서 느껴지는 감정은 어땠나요?  * ex) 긴장감, 공포감, 친근감, 무감정 등"}
                                        hint={"텍스트 입력해주세요"}
                                        onChange={(answer) => handleQuestionChange("PA_Activities_3", answer)}
                                    />
                                ...
                                <div className="tab-pane fade" id="TabView_3" role="tabpanel" aria-labelledby="Tab_3">
                                    ...
                                    <div className="text-lg d-flex mb-4 justify-content-evenly  fw-500">
                                        "기술 친숙도 : ㅇㅇ 기술을 체험하거나 용어를 접하는 횟수"
                                        <br />
                                        * 기본적인 인식 (1점): ㅇㅇ 기술이 무엇인지 기본적으로 알고 있으나, 이에 대해 자세한 정보나 경험이 전혀 없음.
                                        <br />
                                        * 간접적 경험 (2점): ㅇㅇ 기술을 박람회, 전시관 등에서 다른 사람이 사용하는 것을 보거나 한두 차례 직접 체험해봄.
                                        <br />
                                        * 제한적 경험 (3점): ㅇㅇ 기기를 세차례 이상 직접 사용해본 적이 있으나 매우 제한적이며, 기술에 대한 이해도가 낮음.
                                        <br />
                                        * 중간 정도의 친숙도 (4점): 사용자 입장에서 ㅇㅇ 기술을 여러 차례 사용해보았으며, 기본적인 작동 방식과 용도에 대해 이해하고 있음.
                                        <br />
                                        * 상당한 경험 및 이해 (5점): 사용자 입장에서 ㅇㅇ 기술을 자주 사용하며, 다양한 애플리케이션과 기능에 대해 잘 알고 있음.
                                        <br />
                                        * 전문적 지식 및 경험 (6점): 전문가 입장에서 ㅇㅇ 기술 분야에서 개발 경험이나 기초적인 정도의 연구를 수행함.
                                        <br />
                                        * 많은 전문적 지식 및 경험 (7점): 전문가 입장에서 ㅇㅇ 기술에 대해 깊은 지식을 가지고 가르칠 수 있으며, 전문적인 연구를 수행하고 이끌 수 있음.
                                        <br />
                                    </div>

                                    <SevenPointLikert
                                        question={"VR (가상현실) 기술에 얼마나 친숙하신가요?"}
                                        optionLabels={[
                                            { label: "적음" },
                                            { label: "많음" }
                                        ]}
                                    ...
                                    <SevenPointLikert
                                        question={"MR/AR (혼합현실/증강현실) 기술에 얼마나 친숙하신가요?"}
                                        optionLabels={[
                                            { label: "적음" },
                                            { label: "많음" }
                                        ]}
                                        SaveId={"RadioForFamiliarMR"}
                                        radioName={"FamiliarMR"}
                                        RadioIndex={"RadioForFamiliarMR"}
                                        optionNames={[
                                            { label: "1", value: 1 },
                                            { label: "2", value: 2 },
                                            { label: "3", value: 3 },
                                        ...
                                        onChange={(answer) => handleQuestionChange("RadioForFamiliarMR", answer)}
                                    />
