...
function PostCD() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbwjUuVgsG6PiDRu65zSCD4zY7P9uJD36MQh2r6O02cpWcCaYdvxRMkGVAJsddP7J8M/exec";
    ...
    const shuffleContents = () => {
        ...
        const t_sp = [...SARTContents].sort(() => Math.random() - 0.5);
        SetSARTContents(t_sp);
    ...
    const SARTform = [
        ...
        },
        {
            ...
            "key": 4,
            "query": "얼마나 경각심을 가지고 가상의 주변 상황을 관찰하였습니까?",
            "saveId": "SAR_4",
            "leftLable": "경계하지 않음",
            "rightLable": "매우 경계함"
        }, {
            ...
            "key": 10,
            "query": "작업을 수행하는 동안 가상의 주변 환경에 익숙해졌나요? ",
            "saveId": "SAR_10",
            "leftLable": "전혀 아님",
            "rightLable": "매우 그러함"
        },
                                ...
                                <div className="tab-pane fade show active" id="SetupView" role="tabpanel" aria-labelledby="TabSetup">
                                    ...
                                    <RadioSelection
                                        ...
                                        optionNames={[
                                            ...
                                            "LYING_NO_REDIRECTION",
                                            "LYING_HALF_REDIRECTION",
                                            "LYING_FULL_REDIRECTION",

                                            "FOWLER_NO_REDIRECTION",
                                            "FOWLER_FULL_REDIRECTION"
                                        ]}
