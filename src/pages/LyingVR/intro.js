            ...
            <div className="d-flex m-5 hswrap">
                <div className="mt-2 d-flex flex-column">
                    ...
                    style={{ position: "relative", zIndex: 2 }}>
                        ...
                        <a className="btn btn-primary rowBT" href="https://forms.gle/LJhjrRdMN6quYjJz7"
                        ...
                        <div className="col-xl-6 col-md-6 mb-4 m-5 ">
                            ...
                            <a className="btn btn-red rowBT" href="https://forms.gle/xset7dE6GhKGHTi86"
                                target="_blank" rel="noopener noreferrer">
                                사후 설문 (구글 설문지)
                            </a>
