...
function PreQuesiton() {
    ...
    const handleSubmit = async (formValues) => {
        ...
        const link = "https://script.google.com/macros/s/AKfycbzVWL7ZVG20keER8spgU_ZQDs6nLh8N2m2i91zK6YU5LSBaCpGsqAamndPVWkl8ss6w8g/exec"
                            ...
                            <div className="tab-content" id="cardTabContent">
                                ...
                                <div className="tab-pane fade" id="TabView_3" role="tabpanel" aria-labelledby="Tab_3">
                                    ...
                                    <div className="text-lg d-flex mb-4 justify-content-evenly  fw-500">
                                        <b>"VR 기술 친숙도 : VR을 체험하거나 용어를 접하는 횟수" <br/></b>
                                        <br/>* 1점 - 1년에 1번 정도 (once a year)<br/>
                                        * 2점 - 3달에 1번 정도 (once every three months)<br/>
                                        * 3점 - 매달 1번 정도 (once a month) <br/>
                                        * 4점 - 매주 1번 정도 (once a week) <br/>
                                        * 5점 - 매주 3번 정도 (three times a week)<br/>
                                        * 6점 - 매주 5번 정도 (five times a week) <br/>
                                        * 7점 - 매주 5번 정도, 관련 업계에 종사함<br/>
                                    </div>
